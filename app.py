# -*- coding: utf-8 -*-
"""
Created on Tue Sep  7 22:03:28 2021
...
if canvas_result.image_data is not None:
    ...
    st.write('Model Input(Rescaled Image)')
    st.image(rescaled)
